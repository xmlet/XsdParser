...
public class XsdGroup extends XsdNamedElements {
    ...
    /**
     * Asserts if the current object has the name attribute when not being a direct child of the XsdSchema or XsdRedefine
     * element, which is not allowed, throwing an exception in that case.
     */
    private void rule2() {
